...
test_that("returned function fails with something other than ADaM dataframe", {
  check_is_date(column_name = "col_a")() |>
...
test_that("returned function provides correct 'msg' for invalid columns", {
  expect_checker_false(
    ...
    checker = check_is_date(column_name = "col_a"),
    msg = "Column 'col_a' must have data type 'date', but is data type 'integer'."
  )

  expect_checker_false(
    data = dplyr::tibble(col_a = "2020-01-01"),
    checker = check_is_date(column_name = "col_a"),
    msg = "Column 'col_a' must have data type 'date', but is data type 'character'."
  )

  expect_checker_false(
    data = dplyr::tibble(col_a = unclass(as.Date("2020-01-01"))),
    checker = check_is_date(column_name = "col_a"),
    msg = "Column 'col_a' must have data type 'date', but is data type 'numeric'."
  )

  expect_checker_false(
    data = dplyr::tibble(col_a = as.POSIXct("2020-01-01 00:00:00")),
    checker = check_is_date(column_name = "col_a"),
    msg = "Column 'col_a' must have data type 'date', but is data type 'POSIXct', 'POSIXt'."
  )

  dplyr::tibble(col_a = as.Date(NULL)) |>
...
test_that("a message is returned if the column doesn't exist", {
  expect_checker_false(
    ...
    checker = check_is_date(column_name = "col_b"),
    msg = "Column 'col_b' must have data type 'date', but is data type 'NULL'."
  )
})
...
test_that("an appropriate message is returned for 1 invalid factor datatype", {
  expect_checker_false(
    ...
    checker = check_is_date(column_name = "col_a"),
    msg = "Column 'col_a' must have data type 'date', but is data type 'factor'."
  )
})
...
test_that("an appropriate message is returned for 1 invalid logical datatype", {
  expect_checker_false(
    ...
    checker = check_is_date(column_name = "col_a"),
    msg = "Column 'col_a' must have data type 'date', but is data type 'logical'."
  )
