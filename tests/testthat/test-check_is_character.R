...
test_that("returned function fails with something other than ADaM dataframe", {
  check_is_character(column_name = "col_a")() |>
...
test_that("returned function provides correct 'msg' for invalid columns", {
  expect_checker_false(
    ...
    checker = check_is_character(column_name = "col_a"),
    msg = "Column 'col_a' must have data type 'character', but is data type 'integer'."
  )

  expect_checker_false(
    data = dplyr::tibble(col_a = unclass(as.Date("2020-01-01"))),
    checker = check_is_character(column_name = "col_a"),
    msg = "Column 'col_a' must have data type 'character', but is data type 'numeric'."
  )

  expect_checker_false(
    data = dplyr::tibble(col_a = as.POSIXct("2020-01-01 00:00:00")),
    checker = check_is_character(column_name = "col_a"),
    msg = "Column 'col_a' must have data type 'character', but is data type 'POSIXct', 'POSIXt'."
  )

  dplyr::tibble(col_a = as.character(NULL)) |>
    check_is_character(column_name = "col_a")() |>
...
test_that("a message is returned if the column doesn't exist", {
  expect_checker_false(
    data = dplyr::tibble(col_a = as.character("2020-01-01")),
    checker = check_is_character(column_name = "col_b"),
    msg = "Column 'col_b' must have data type 'character', but is data type 'NULL'."
  )
})
...
test_that("the function returns 'TRUE' with valid column", {
  ...
  expect_checker_true(
    data = dplyr::tibble(col_a = c("2020-01-01", "text")),
    checker = check_is_character(column_name = "col_a")
  )
})
...
test_that("an appropriate message is returned for 1 invalid factor datatype", {
  expect_checker_false(
    ...
    checker = check_is_character(column_name = "col_a"),
    msg = "Column 'col_a' must have data type 'character', but is data type 'factor'."
  )
})
...
test_that("an appropriate message is returned for 1 invalid logical datatype", {
  expect_checker_false(
    ...
    checker = check_is_character(column_name = "col_a"),
    msg = "Column 'col_a' must have data type 'character', but is data type 'logical'."
  )
...
test_that("an appropriate message is returned for 1 invalid date datatype", {
  expect_checker_false(
    ...
    checker = check_is_character(column_name = "col_a"),
    msg = "Column 'col_a' must have data type 'character', but is data type 'Date'."
  )
})
...
test_that("return 'TRUE' for 1 valid text datatype", {
...
test_that("return 'TRUE' for 1 valid character datatype", {
  dplyr::tibble(col_a = "text") |>
    check_is_character(column_name = "col_a")() |>
    expect_true()
})
...
test_that("return 'TRUE' for 2 valid character datatypes", {
...
test_that("no message is returned for 2 valid datatypes", {
  expect_checker_true(
    data = dplyr::tibble(col_a = c("text", "1234")),
    checker = check_is_character(column_name = "col_a")
  )
})
