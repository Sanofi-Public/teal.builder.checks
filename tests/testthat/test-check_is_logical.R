...
test_that("returned function provides correct 'msg' for invalid columns", {
  expect_checker_false(
    ...
    checker = check_is_logical(column_name = "col_a"),
    msg = "Column 'col_a' must have data type 'logical', but is data type 'integer'."
  )

  expect_checker_false(
    data = dplyr::tibble(col_a = "2020-01-01"),
    checker = check_is_logical(column_name = "col_a"),
    msg = "Column 'col_a' must have data type 'logical', but is data type 'character'."
  )

  expect_checker_false(
    data = dplyr::tibble(col_a = unclass(as.Date("2020-01-01"))),
    checker = check_is_logical(column_name = "col_a"),
    msg = "Column 'col_a' must have data type 'logical', but is data type 'numeric'."
  )

  dplyr::tibble(col_a = as.logical(NULL)) |>
    check_is_logical(column_name = "col_a")() |>
...
test_that("a message is returned if the column doesn't exist", {
  expect_checker_false(
    ...
    checker = check_is_logical(column_name = "col_b"),
    msg = "Column 'col_b' must have data type 'logical', but is data type 'NULL'."
  )
})
...
test_that("an appropriate message is returned for 1 invalid factor datatype", {
  expect_checker_false(
    ...
    checker = check_is_logical(column_name = "col_a"),
    msg = "Column 'col_a' must have data type 'logical', but is data type 'factor'."
  )
})
...
test_that("an appropriate message is returned for 1 invalid date datatype", {
  expect_checker_false(
    ...
    checker = check_is_logical(column_name = "col_a"),
    msg = "Column 'col_a' must have data type 'logical', but is data type 'Date'."
  )
})
...
test_that("an appropriate message is returned for 1 invalid datetime datatype", {
  expect_checker_false(
    ...
    checker = check_is_logical(column_name = "col_a"),
    msg = "Column 'col_a' must have data type 'logical', but is data type 'POSIXct', 'POSIXt'."
  )
})
...
test_that("return 'TRUE' for 1 valid TRUE datatype", { # maybe add tests later
...
test_that("no message is returned for 1 valid datatype", {
  ...
  expect_checker_true(
    data = dplyr::tibble(col_a = NA),
    checker = check_is_logical(column_name = "col_a")
  )
})

test_that("return 'TRUE' for 2 valid logical datatypes", {
